            ...
            `}>
                ...
                <div className="p-3 mt-auto mb-3 mx-3 bg-slate-50 border border-slate-100 rounded-lg flex items-center gap-2.5">
                    ...
                    <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs text-slate-500 truncate">ID: {user?.id?.substring(0,8) || "ADM-2024"}</p>
                    </div>
                </div>
                    ...
                    <div className="flex items-center gap-6">
                        ...
                        <div className="flex items-center gap-3 pl-4 border-l border-slate-200">
                            <div className="text-right hidden sm:block">
                                ...
                                <p className="text-[10px] font-bold text-slate-500 uppercase tracking-wider">ID: {user?.id?.substring(0,8) || "ADM-2024"}</p>
                            </div>
